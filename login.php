...
<head>
    ...
    <style>
        ...
        .form-container { max-width: 420px; margin: 100px auto 0 auto; background: rgba(26,26,26,0.9); padding: 40px; border-radius: 15px; box-shadow: 0 8px 32px rgba(0,0,0,0.5); border: 1px solid rgba(165,42,42,0.3);}
        .form-container h2 { color: #A52A2A; font-family: 'Playfair Display', serif; text-align: center; margin-bottom: 30px; font-weight: 700;}
        .form-label { color: #f0f0f0; font-weight: 600;}
        .form-control { background-color: rgba(0,0,0,0.3); border: 1px solid rgba(165,42,42,0.4); color: #f0f0f0;}
        .form-control:focus { background-color: rgba(0,0,0,0.5); border-color: #A52A2A; color: #fff; box-shadow: none;}
        .btn-primary { background-color: #A52A2A; border-color: #A52A2A; color: #ffffff; font-weight: 600; transition: all 0.3s;}
        .btn-primary:hover { background-color: #8B0000; border-color: #8B0000; color: #ffffff;}
