...
<head>
    ...
    <style>
        body { background-color: #6B1C3E; color: #f0f0f0; font-family: 'Montserrat', Arial, sans-serif; min-height: 100vh; }
        .video-background { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; object-fit: cover; z-index: -2; }
        .video-overlay { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(107,28,62,0.7); z-index: -1; }
        .navbar { background-color: rgba(107,28,62,0.92)!important; border-bottom: 1px solid rgba(212,175,55,0.2);}
        .navbar-brand img { height: 80px; }
        .form-container { max-width: 420px; margin: 100px auto 0 auto; background: rgba(107,28,62,0.9); padding: 40px; border-radius: 15px; box-shadow: 0 8px 32px rgba(0,0,0,0.5); border: 1px solid rgba(212,175,55,0.3);}
        ...
        .btn-primary { background-color: #D4AF37; border-color: #D4AF37; color: #6B1C3E; font-weight: 600; transition: all 0.3s;}
