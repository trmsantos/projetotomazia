...
<head>
    ...
    <style>
        ...
        .navbar { background-color: rgba(26,26,26,0.92)!important; border-bottom: 1px solid rgba(139,69,19,0.2);}
        .navbar-brand img { height: 80px; }
        .form-container { max-width: 420px; margin: 100px auto 0 auto; background: rgba(26,26,26,0.9); padding: 40px; border-radius: 15px; box-shadow: 0 8px 32px rgba(0,0,0,0.5); border: 1px solid rgba(139,69,19,0.3);}
        .form-container h2 { color: #8B4513; font-family: 'Playfair Display', serif; text-align: center; margin-bottom: 30px; font-weight: 700;}
        .form-label { color: #f0f0f0; font-weight: 600;}
        .form-control { background-color: rgba(0,0,0,0.3); border: 1px solid rgba(139,69,19,0.4); color: #f0f0f0;}
        .form-control:focus { background-color: rgba(0,0,0,0.5); border-color: #8B4513; color: #fff; box-shadow: none;}
        .btn-primary { background-color: #8B4513; border-color: #8B4513; color: #1a1a1a; font-weight: 600; transition: all 0.3s;}
        .btn-primary:hover { background-color: transparent; border-color: #8B4513; color: #8B4513;}
